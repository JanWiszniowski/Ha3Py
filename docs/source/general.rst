...
and instrumental data, even if the catalogue is significantly incomplete.
...
In addition to executing the command line tool, it is also possible to build your hazard evaluation programme
